...
void LEVEL1_load (Scene_t * self) {
    ...
    SDL_Texture * blackHeart = load_png("assets/BlackHeart.png") ; 
    ...
    TTF_Font * font0 = TTF_OpenFont("assets/PressStart2P-Regular.ttf", 16) ;
    TTF_Font * font1 = TTF_OpenFont("assets/PressStart2P-Regular.ttf", 20) ;
    TTF_Font * font2 = TTF_OpenFont("assets/PressStart2P-Regular.ttf", 22) ;
    TTF_Font * font3 = TTF_OpenFont("assets/PressStart2P-Regular.ttf", 32) ;
    listFont->stack(listFont, font0);
    listFont->stack(listFont, font1);
    listFont->stack(listFont, font2);
    listFont->stack(listFont, font3);

    load_texts_from_file("data/textsLevel1.csv", listFont, listText);
...
void LEVEL1_update (Scene_t * self, SceneManager_t * manager) {
    ...
    case STATE_INTRO :;
        ...
        text_list_update_from_file(listText, listFont, "data/textsLevel1.csv");
...
void init_map (Map_t * map) {
    ...
    if (existe(map)) {
        ...
        SDL_Texture * spriteSheet1 = load_png("assets/projectileVertical.png") ;
