...
void DESKTOP_load(Scene_t *self) {
    ...
    TTF_Font * font1 = TTF_OpenFont("assets/PressStart2P-Regular.ttf", 12) ;
    TTF_Font * font2 = TTF_OpenFont("assets/PressStart2P-Regular.ttf", 18) ;
    TTF_Font * font3 = TTF_OpenFont("assets/PressStart2P-Regular.ttf", 20) ;
    TTF_Font * font4 = TTF_OpenFont("assets/PressStart2P-Regular.ttf", 24) ;
    TTF_Font * font5 = TTF_OpenFont("assets/PressStart2P-Regular.ttf", 28) ;
    ...
    load_texts_from_file("data/textsDesktop.csv", listFont, listText);
...
void DESKTOP_update (Scene_t * self, SceneManager_t * manager) {
    ...
    if (info->state == STATE_END) {
        ...
        text_list_update_from_file(listText, listFont, "data/textsDesktop.csv");
    }
...
void init_desktop_main_window (Desktop_t * desktop, WinTheme_t theme ) {
    ...
    window->background = load_png("assets/desktop_glitch2.png") ;
    if (!existe(window->background)) {
        printf("Erreur creation background dans load_window_from_file\n"); 
        return ;
    }

    window->spriteSheet = load_png("assets/objectsDesktopScene.png") ;
    ...
    init_widgets_from_file(window->tabWidget, "data/desktopWidgets.csv", theme);
    ...
    load_windows_from_file(desktop->listWindow, "data/desktopWindows.csv", (WinTheme_t){theme.font, theme.textColor, (SDL_Color){0, 0, 0, 0}});
}