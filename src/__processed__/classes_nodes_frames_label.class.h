#ifndef __PROCESSED__CLASSES_NODES_FRAMES_LABEL_H
#define __PROCESSED__CLASSES_NODES_FRAMES_LABEL_H
...
void __class_method_label_free(void * __retValueVP__, va_list args);
#endif
