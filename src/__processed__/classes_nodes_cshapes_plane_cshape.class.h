#ifndef __PROCESSED__CLASSES_NODES_CSHAPES_PLANE_CSHAPE_H
#define __PROCESSED__CLASSES_NODES_CSHAPES_PLANE_CSHAPE_H
...
void __class_method_planecshape_get_model(void * __retValueVP__, va_list args);
#endif
