#line 1 "src/io/model_loaders/mtl_loader.c"
#include "../../raptiquax.h"
    ...
    do {
        ...
        case 'm': ;
            ...
            if (!strcmp(textureType, "Px"))
                (*materials)[mi].textureMaps[PARALLAX_MATERIAL_PROPERTY] = load_texture_from_path(fullPath, GL_R8, true);
            if (!strcmp(textureType, "Pr"))
                (*materials)[mi].textureMaps[ROUGHNESS_MATERIAL_PROPERTY] = load_texture_from_path(fullPath, GL_R8, true);
            if (!strcmp(textureType, "Pm"))
                (*materials)[mi].textureMaps[METALLIC_MATERIAL_PROPERTY] = load_texture_from_path(fullPath, GL_R8, true);
            if (!strcmp(textureType, "Ps"))
                (*materials)[mi].textureMaps[SHEEN_MATERIAL_PROPERTY] = load_texture_from_path(fullPath, GL_R8, true);
