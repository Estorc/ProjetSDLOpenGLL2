...
unsigned int get_collision_code(Node *shapeA, Node *shapeB) {
    ...
    call_method_0(METHOD(get_priority,shapeA,&priorityA));
    call_method_0(METHOD(get_priority,shapeB,&priorityB));
...
void apply_collision(Node *shapeA, Node *shapeB, vec3 collisionNormal, vec3 angularNormal, float penetrationDepth) {
    ...
    call_method_0(METHOD(is_body,(shapeA->parent),&conditionA));
    call_method_0(METHOD(is_body,(shapeB->parent),&conditionB));
    if (conditionA && conditionB)
        apply_body_collision(shapeA, shapeB, collisionNormal, angularNormal, penetrationDepth);
    call_method_0(METHOD(is_area,(shapeA->parent),&conditionA));
    if (conditionA)
        call_method_0(METHOD(collect_node,(shapeA->parent),shapeB->parent, penetrationDepth));
    call_method_0(METHOD(is_area,(shapeB->parent),&conditionB));
    if (conditionB)
        call_method_0(METHOD(collect_node,(shapeB->parent),shapeA->parent, penetrationDepth));
