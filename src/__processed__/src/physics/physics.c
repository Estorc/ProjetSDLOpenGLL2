...
void apply_body_collision(Node *shapeA, Node *shapeB, vec3 collisionNormal, vec3 angularNormal, float penetrationDepth) {
    ...
    call_method_0(METHOD(get_mass,(shapeB->parent),&massB));

    // Calculate relative velocity
    vec3 velocityA, velocityB;
    call_method_0(METHOD(get_velocity,(shapeA->parent),velocityA));
    call_method_0(METHOD(get_velocity,(shapeB->parent),velocityB));
    ...
    vec3 comA, comB;
    call_method_0(METHOD(get_center_of_mass,(shapeA->parent),comA));
    call_method_0(METHOD(get_center_of_mass,(shapeB->parent),comB));
    ...
    call_method_0(METHOD(apply_impulse,(shapeA->parent),impulseA, torqueA, correction, &momentOfInertia));
    glm_vec3_negate(impulseB);
    glm_vec3_negate(correction);
    call_method_0(METHOD(apply_impulse,(shapeB->parent),impulseB, torqueB, correction, &momentOfInertia));
}
