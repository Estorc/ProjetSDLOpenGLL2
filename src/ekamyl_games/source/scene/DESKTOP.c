...
void init_desktop_main_window (Desktop_t * desktop, WinTheme_t theme ) {
    ...
    window->spriteSheet = load_png("assets/ekamyl_games/assets/objectsDesktopScene.png") ;
    ...
    init_widgets_from_file(window->tabWidget, "assets/ekamyl_games/data/desktopWidgets.csv", theme);
    ...
    load_windows_from_file(desktop->listWindow, "assets/ekamyl_games/data/desktopWindows.csv", (WinTheme_t){theme.font, theme.textColor, (SDL_Color){0, 0, 0, 0}});
}