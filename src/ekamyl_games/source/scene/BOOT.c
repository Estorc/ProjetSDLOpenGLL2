...
void BOOT_load (Scene_t * self) {
    ...
    load_textures_from_file(listTexture, "assets/ekamyl_games/data/donneesTexturesBootScene.csv") ;
...
void BOOT_update (Scene_t * self, SceneManager_t * manager) {
    ...
    texture_list_update_from_file(listTexture, "assets/ekamyl_games/data/donneesTexturesBootScene.csv");
